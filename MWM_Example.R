...
dfFin<-rbind(df1,df2,df3,df4,df5) 
...
sink(paste(outpath, "Winding_Learning_Models.txt"))
...
summary(glht(lm_winding_trials, emm(pairwise ~ APOE*Sex, adjust="sidak"))) 
...
sink(paste(outpath, "Dist_D5_Models.txt"))
...
summary(glht(lm_Distance_d5, emm(pairwise ~ APOE*Sex, adjust="sidak"))) 
summary(glht(lm_Distance_d5, emm(pairwise ~ APOE| Sex)))
summary(glht(lm_Distance_d5, emm(pairwise ~ Sex | APOE)))
sink()


sink(paste(outpath, "NormSWDist_D5_Models.txt"))
...
summary(glht(lm_NormSWDist_d5, emm(pairwise ~ APOE*Sex, adjust="sidak"))) 
summary(glht(lm_NormSWDist_d5, emm(pairwise ~ APOE| Sex)))
summary(glht(lm_NormSWDist_d5, emm(pairwise ~ Sex | APOE)))
sink()


sink(paste(outpath, "Winding_D5_Models.txt"))
...
#33333
summary(glht(lm_Winding_d5, emm(pairwise ~ APOE*Sex, adjust="sidak"))) 
...
sink(paste(outpath, "Dist_D8_Models.txt"))
...
summary(glht(lm_Distance_d8, emm(pairwise ~ APOE*Sex, adjust="sidak"))) 
summary(glht(lm_Distance_d8, emm(pairwise ~ APOE| Sex)))
summary(glht(lm_Distance_d8, emm(pairwise ~ Sex | APOE)))
sink()

#NormSWDist
sink(paste(outpath, "NormSWDist_D8_Models.txt"))
...
summary(glht(lm_NormSWDist_d8, emm(pairwise ~ APOE*Sex, adjust="sidak"))) 
summary(glht(lm_NormSWDist_d8, emm(pairwise ~ APOE| Sex)))
summary(glht(lm_NormSWDist_d8, emm(pairwise ~ Sex | APOE)))
sink()


sink(paste(outpath, "Winding_D8_Models.txt"))
...
summary(glht(lm_Winding_d8, emm(pairwise ~ APOE*Sex, adjust="sidak"))) 
